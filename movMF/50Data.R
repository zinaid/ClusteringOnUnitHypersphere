...
# Assuming `cluster` is the column containing the true labels
true_labels <- my_data$cluster
print(true_labels)

# Converting x, y, z to numeric if necessary
...
# Prepare the data for clustering (remove cluster column)
data <- my_data[, -4]
...
# Compute macro recall and precision
